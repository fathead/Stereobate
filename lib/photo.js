...
module.exports = [
  ...
  function(req, res, next) {
    ...
    var exactPath = _.sprintf('/%s/%s/%s/%s/%s_%s_%s_%s.jpg'
      , systemid 
      , content_id[0] + content_id[1]
      , content_id[2]
      , content_id
    ...
    var originalPath = _.sprintf('/%s/%s/%s/%s/%s.jpg'
      , systemid 
      , content_id[0] + content_id[1]
      , content_id[2]
      , content_id
    ...
    var exactPathAbs = path.normalize(__dirname + '/../photos' + exactPath);
    var originalPathAbs = path.normalize(__dirname + '/../photos' + originalPath);
